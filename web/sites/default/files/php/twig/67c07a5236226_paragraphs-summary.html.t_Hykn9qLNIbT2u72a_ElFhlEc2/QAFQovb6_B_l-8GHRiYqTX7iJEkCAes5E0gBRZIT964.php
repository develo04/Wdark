...
class __TwigTemplate_010634261fef78f183cdd723c5576da2 extends Template
{
...
($context["expanded"] ?? null)) ? ("paragraphs-expanded-description") : ("paragraphs-collapsed-description"))];
      ...
      ";
                ...
                if ( !Twig\Extension\CoreExtension::testEmpty(($context["content"] ?? null))) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["content_item"]) {
                        ...
                        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $context["content_item"], "html", null, true);
                        yield "</span>";
                        // line 27
                ...
                if ( !Twig\Extension\CoreExtension::testEmpty(($context["behaviors"] ?? null))) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["behavior_item"]) {
                        ...
                        if ( !(null === CoreExtension::getAttribute($this->env, $this->source, $context["behavior_item"], "label", [], "any", false, false, true, 35))) {
                            ...
                            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["behavior_item"], "label", [], "any", false, false, true, 36), "html", null, true);
                            yield "</span>";
                        }
                        // line 38
                        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["behavior_item"], "value", [], "any", false, false, true, 38), "html", null, true);
                        // line 39
                        yield "</span>";
                    }
                    $_parent = $context['_parent'];
  ...
  ";
    ...
    {
        return new Source("", "modules/contrib/paragraphs/templates/paragraphs-summary.html.twig", "/usr/local/var/www/drupal-wdark/web/modules/contrib/paragraphs/templates/paragraphs-summary.html.twig");
    }
